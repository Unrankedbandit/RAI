...
// STASHED: the original home dashboard (portfolio stats/donut/activity), moved
// off the landing route when / became the public landing page. Not in the nav —
// kept because the live-stats composition may earn a place back for returning
// users. Delete when the product direction settles.
...
export default function DashboardPage() {
  ...
  if (live.status === "loading") {
    return (
      <PortfolioShell>
        <div className="text-2xl font-semibold text-ink">Dashboard</div>
