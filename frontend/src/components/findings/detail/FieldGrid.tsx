...
/**
 * Two-column field grid — NOT a hero banner. Left: Type / Severity /
 * Workstream. Right: Status / Owner / Detected. All colors resolve through
 * lib/findings helpers; the severity flag is an inline-styled dot.
 */
