...
async def portfolio():
    ...
    Response envelope: {"projects": [...rows...], "skipped_invalid": [names]}.
    A stored file that fails schema validation is SKIPPED (logged + named in
    skipped_invalid) rather than 500ing the entire board — one corrupt file
    must not poison the portfolio."""
